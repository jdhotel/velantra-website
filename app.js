/* --------------------------------------------------
   Vilva Boutique Hotel - Client Application Script
-------------------------------------------------- */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    handleFormSubmit('contactForm', null, 'Message Sent', 'Thank you for reaching out. The Vilva customer care desk will reply within 24 hours.');
    ...
    if (newsletterForm) {
        newsletterForm.addEventListener('submit', (e) => {
            e.preventDefault();
            showToast('Subscribed', 'Thank you for subscribing to Vilva insights and promotions.');
